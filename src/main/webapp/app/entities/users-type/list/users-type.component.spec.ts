...
describe('UsersType Management Component', () => {
  let comp: UsersTypeComponent;
  let fixture: ComponentFixture<UsersTypeComponent>;
  let service: UsersTypeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'users-type', component: UsersTypeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(UsersTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.usersTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
